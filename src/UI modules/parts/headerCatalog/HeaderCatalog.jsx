    ...
    <header className={`${cl.header}`}>
      <div className={cl.headerContainer}>
        ...
        <ul className={cl.headerNavigation}>
          <li>
            <Link to='/gasolineTools' className={cl.headerNavigationLink}>
              Unelte Pe Benzină
            </Link>
          </li>
          <li>
            <Link to='/electroTools' className={cl.headerNavigationLink}>
              Unelte de Electice
            </Link>
          </li>
          <li>
            <Link to='/rulerTools' className={cl.headerNavigationLink}>
