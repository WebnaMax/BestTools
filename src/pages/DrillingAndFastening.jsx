...
function DrillingAndFastening(props) {
  ...
  useEffect(() => {
    ...
    const categoryId = '688cb2502a41e77bbbe663f7'; // Замените на реальный ID
      ...
      <div className="container">
        <div className="sectionTitleContainer toolsCatalogTitle">
          <div className="titleSecondary">
            <h2>Unelte noastre pentru găurire și înșurubare</h2>
          </div>
          <div className="titleDescription">
            <p>
              Unelte electrice pentru găurirea precisă a lemnului, metalului sau betonului și înșurubarea rapidă. Bormașini, șurubelnițe electrice și ciocane rotopercutoare pentru lucrări eficiente și profesionale.
            </p>
          </div>
        </div>
...
export default DrillingAndFastening;