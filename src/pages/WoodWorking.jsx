...
function WoodWorking(props) {
  ...
  useEffect(() => {
    const categoryId = '688cb2712a41e77bbbe663fd'; // Замените на реальный ID
      ...
      <div className="container">
        <div className="sectionTitleContainer toolsCatalogTitle">
          <div className="titleSecondary">
            <h2>Unelte noastre pentru prelucrarea lemnului și a altor materiale</h2>
          </div>
          <div className="titleDescription">
            <p>
              Unelte electrice pentru modelarea și finisarea lemnului, metalului sau plasticului. Rindele electrice, freze și mașini de gravat pentru proiecte precise și creative.
            </p>
          </div>
        </div>
