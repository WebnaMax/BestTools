...
function BrushCutters(props) {
  ...
  useEffect(() => {
    const categoryId = '688cb2122a41e77bbbe663ef';
      ...
      <div className="container">
        <div className="sectionTitleContainer toolsCatalogTitle">
          ...
          <div className="titleDescription">
            <p>
              Motocoase eficiente pentru cosirea ierbii și tunderea vegetației. Ideale pentru grădini și terenuri mari.
            </p>
          </div>
        </div>
