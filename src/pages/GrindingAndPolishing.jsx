...
function GrindingAndPolishing(props) {
  ...
  useEffect(() => {
    ...
    const categoryId = '688cb2622a41e77bbbe663f9'; // Замените на реальный ID
      ...
      <div className="container">
        <div className="sectionTitleContainer toolsCatalogTitle">
          <div className="titleSecondary">
            <h2>Unelte noastre pentru șlefuire și lustruire</h2>
          </div>
...
export default GrindingAndPolishing;