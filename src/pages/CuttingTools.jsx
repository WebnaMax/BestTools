...
function CuttingTools(props) {
  ...
  useEffect(() => {
    const categoryId = '688cb2442a41e77bbbe663f5';
      ...
      <div className="container">
        <div className="sectionTitleContainer toolsCatalogTitle">
          <div className="titleSecondary">
            <h2>Unelte noastre pentru tăiere și debitare</h2>
          </div>
          <div className="titleDescription">
            <p>
              Unelte electrice pentru tăieri precise și rapide în lemn, metal sau alte materiale. De la ferăstraie circulare la trimmere electrice, găsești soluții eficiente pentru orice proiect de construcții sau grădinărit.
            </p>
          </div>
        </div>
