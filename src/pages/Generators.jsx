...
function Generators(props) {
  ...
  useEffect(() => {
    const categoryId = '688cb2282a41e77bbbe663f1'; // Замените на реальный ID
      ...
      <div className="container">
        <div className="sectionTitleContainer toolsCatalogTitle">
          ...
          <div className="titleDescription">
            <p>
              Generatoare fiabile pentru alimentare cu energie în construcții, camping sau situații de urgență. Putere garantată oriunde.
            </p>
          </div>
        </div>
